...
// Prepare for a new section of the current region.
  ...
  if( ((kb-ka-mix2.size+baseband_size)&baseband_mask)< baseband_sizhalf)
    {
    region_flag=2;
    }
  else
