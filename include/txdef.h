...
#define SSB_DELAY_EXTRA 2


#define MAX_DISPLAY_TYPES 3
#define MAX_SSBPROC_FILES 15
...
#define SSB_MAX_MICOUT_GAIN 80
#define SSB_MIN_RF1_GAIN -50
#define SSB_MAX_RF1_GAIN 120
#define MAX_DYNRANGE 0.0000001 // -70dB for weakest signal
#define TX_AGC_THRESHOLD 1.

#define TX_SETUP_AD 0
#define TX_SETUP_MUTE 1
#define TX_SETUP_MICAGC 2
#define TX_SETUP_RF1AGC 3
#define TX_SETUP_RF1CLIP 4

#define TX_BAR_AD_LINE 9
#define TX_BAR_MUTE_LINE 11
#define TX_BAR_MICAGC_LINE 13
#define TX_BAR_RF1AGC_LINE 15
#define TX_BAR_RF1CLIP_LINE 17
#define TX_BAR_ALC_LINE 19
#define TXPAR_INPUT_LINE 21

#define MIC_KEY_LINE 12
...
extern int tx_indicator_first_pixel;
...
extern SOUNDCARD_SIZES txda;
extern SOUNDCARD_SIZES txad;


extern float tx_resamp_ampfac1;
extern float tx_resamp_ampfac2;
extern int *txmem_handle;
...
extern int old_rxtx_state;
extern int rxtx_state;
extern int rxtx_wait;
extern int tx_mode;
