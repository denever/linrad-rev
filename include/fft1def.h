...
extern float interrupt_rate;
extern char *fft1_handle;
...
extern unsigned int save_rw_bytes;
...
extern int timf1p_pna;
extern int timf1p_pnb;
extern int timf1p_pnx;
...
void simd1_16_win(void);
void simd1_16_nowin(void);
void simd1_32_win(void);
void simd1_32_nowin(void);
void real_to_complex_input(void);
void fft1_update_liminfo(void);
void compress_rawdat(void);
